...
/* ---------------------- SI OK, ENVOI DU BUFFER AU SERVER ----------------------*/ 
	...
	if(nb_mot == 4){
        ...
        printf("\n------------ VERIFICATION DU MOT TROUVE -----------\n\n"); /* Affichage du message de confirmation du nombre d'arguments */

        zmq_send(requester, choix, 30, 0); /* Envoi de la fonction au server */
...
/* ---------------------- SINON, MESSAGE D'ERREUR ----------------------*/ 
        ...
        printf("\nMerci de bien entrer le bon nombre d'arguments pour la fonction FOUND\n\n"); /* Affichage du message d'erreur de nombre d'arguments */
        printf("Du type : FOUND <mot> <ij1> <ij2>"); /* Affichage du message du type attendu de la fonction */
        printf("\n\n--------------------\n\n");
        return 0;
